...
<body class="font-sans bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-blue-900 transition-colors duration-200 overflow-x-hidden">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden">
            ...
            <header class="glass dark:glass-dark border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
                <div class="px-6 py-4">
                    <!-- Top row: Menu burger + Titre + Actions globales -->
                    ...
                    <!-- Second row: Breadcrumbs + Page Actions -->
