...
<div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('admin.partners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-8">
            @csrf
                ...
                <div>
                    ...
                    <div id="logoPreview" class="mt-4 hidden">
                        ...
                        <img id="logoPreviewImg" 
                             src="" 
                             alt="Aperçu logo" 
                             class="w-32 h-32 object-contain bg-gray-100 dark:bg-gray-800 rounded-lg p-2 border-2 border-gray-300 dark:border-gray-600">
                    </div>
                </div>
