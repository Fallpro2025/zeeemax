...
@section('title', 'Modifier un Administrateur - ZEEEMAX Admin')
@section('page-title', 'Modifier un Administrateur')
@section('page-description', 'Éditez les informations de l\'administrateur')
...
<div>
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-300">Administrateur : <strong>{{ $admin->nom }}</strong></p>
        </div>
    ...
    <div class="glass dark:glass-dark rounded-2xl p-8 animate-slide-up">
        <form action="{{ route('admin.admins.update', $admin) }}" method="POST" class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4">
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Laissez vide pour ne pas modifier le mot de passe</p>
