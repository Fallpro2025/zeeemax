...
@section('title', 'Créer une Valeur - ZEEEMAX Admin')
@section('page-title', 'Créer une Valeur')
@section('page-description', 'Ajoutez une nouvelle valeur')
...
<div>
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-300">Ajoutez une nouvelle valeur</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('admin.valeurs.store') }}" method="POST" class="space-y-6 p-8">
            @csrf
            ...
            <div>
                ...
                <textarea id="description" 
                          ...
                          rows="6"
                          class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                          placeholder="Décrivez cette valeur...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="grid grid-cols-6 gap-2 p-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-800/50 max-h-64 overflow-y-auto">
                        ...
                        <button type="button" 
                                onclick="selectIcon('')"
                                class="icon-option p-2 border-2 rounded-lg transition-all duration-200 flex flex-col items-center justify-center {{ old('icon', '') === '' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-transparent hover:border-gray-400 dark:hover:border-gray-500 bg-white dark:bg-gray-700' }}">
                        ...
                        <button type="button" 
                                ...
                                class="icon-option p-2 border-2 rounded-lg transition-all duration-200 flex flex-col items-center justify-center {{ old('icon', '') === $iconKey ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-transparent hover:border-gray-400 dark:hover:border-gray-500 bg-white dark:bg-gray-700' }}"
                                data-icon="{{ $iconKey }}">
                    ...
                    <div id="icon-preview" class="mt-3 p-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800/50 flex items-center justify-center" style="min-height: 60px; display: none;">
                ...
                <div>
                    ...
                    <select id="couleur" name="couleur" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                        <option value="purple" {{ old('couleur') === 'purple' ? 'selected' : '' }}>Violet</option>
                        <option value="blue" {{ old('couleur') === 'blue' ? 'selected' : '' }}>Bleu</option>
                        <option value="purple-blue" {{ old('couleur') === 'purple-blue' ? 'selected' : '' }}>Violet-Bleu (dégradé)</option>
                    </select>
                    @error('couleur')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
