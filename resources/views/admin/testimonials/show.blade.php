                    ...
                    @if($testimonial->avatar_url)
                        <div class="flex-shrink-0">
                            <img src="{{ str_starts_with($testimonial->avatar_url, 'http') ? $testimonial->avatar_url : asset($testimonial->avatar_url) }}" 
                                 ...
                                 onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($testimonial->nom_client) }}&background=blue&color=fff&size=64'">
                        </div>
                    @else
        ...
        <div class="space-y-6">
            ...
            <div class="glass dark:glass-dark rounded-2xl p-6 animate-slide-up" style="animation-delay: 0.1s;">
                ...
                <div class="space-y-3">
                    ...
                    <form action="{{ route('admin.testimonials.destroy', $testimonial) }}" method="POST" class="delete-form-show">
                        @csrf
                        @method('DELETE')
                    </form>
                    <button type="button" 
                            onclick="confirmDeleteShow({{ $testimonial->id }}, '{{ $testimonial->nom_client }}')"
