...
<div>
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-300">Ajoutez un nouveau service à votre catalogue</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-6 p-8">
            ...
            <div>
                ...
                <div id="icone-preview" class="mb-4 p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-800/50 flex items-center justify-center" style="min-height: 80px; display: none;">
                            ...
                            <div class="grid grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-3">
                                @foreach([
                                    ...
                                    <button type="button" 
                                            ...
                                            class="icone-btn p-3 border-2 border-transparent hover:border-blue-500 rounded-lg transition-colors text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 group">
