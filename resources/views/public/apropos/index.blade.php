...
<!-- About Content -->
<section class="relative py-20 bg-white min-h-[600px] flex items-center overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                @if($apropos && $apropos->titre)
                    <h2 class="text-4xl font-black mb-6 tracking-tight title-gradient-glass-sm">{{ $apropos->titre }}</h2>
                @else
                    <h2 class="text-4xl font-black mb-6 tracking-tight title-gradient-glass-sm">Notre histoire</h2>
                @endif
...
<section class="py-24 bg-gradient-to-br from-purple-600 via-purple-700 to-blue-700 text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-black mb-6 tracking-tight title-gradient-glass-white">Nos réalisations en chiffres</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                <div class="icon-3d-gradient w-20 h-20 rounded-full mx-auto mb-6 flex items-center justify-center">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2V6"></path>
                    </svg>
                </div>
                <div class="text-5xl font-black mb-3">+100</div>
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                ...
                <div class="text-5xl font-black mb-3">+65</div>
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                ...
                <div class="text-5xl font-black mb-3">6</div>
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                ...
                <div class="text-5xl font-black mb-3">+3</div>
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20">
            <h2 class="text-4xl md:text-5xl font-black mb-6 tracking-tight title-gradient-glass">Nos valeurs</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-2xl border-2 border-purple-100 hover:border-purple-300 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                <div class="icon-3d-gradient w-16 h-16 rounded-xl flex items-center justify-center mb-6">
                    <div class="icon-svg-wrapper">
                ...
                <h3 class="text-2xl font-bold mb-4 tracking-tight title-gradient-glass-sm">{{ $valeur->titre }}</h3>
...
<section class="py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20">
            <h2 class="text-4xl md:text-5xl font-black mb-6 tracking-tight title-gradient-glass">Notre équipe</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto font-light">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center min-h-[420px] flex flex-col max-w-sm mx-auto group">
                <div class="w-48 h-48 rounded-xl mx-auto mb-6 overflow-hidden border-2 border-purple-100 shadow-md">
                    ...
                    <h3 class="text-2xl font-bold mb-2 tracking-tight title-gradient-glass-sm">{{ $member->nom }}</h3>
